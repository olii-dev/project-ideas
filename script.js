const ideas = [
    ...
    "Build a to-do list app with reminder notifications!",
    "Design a virtual resume or CV generator!",
    "Create a note-taking app with categories and search functionality!",
    "Build a calculator app with advanced features like unit conversion!",
    "Design a countdown timer for events or tasks!",
    "Create a simple chat application with real-time messaging!",
    ...
    "Build a habit tracker app with streaks and motivational quotes!",
